...
const PermissionsPage: React.FC = () => {
  ...
  const handleExportCSV = () => {
    ...
    setTimeout(() => {
      ...
      downloadCSVFile('system_permissions_matrix', headers, rows)
        ...
        <div className="flex flex-wrap items-center gap-2 w-full lg:w-auto">
          <div className="relative flex-1 min-w-[260px] sm:max-w-xs">
            <SearchInput
              value={search}
              onChange={setSearch}
              placeholder="Search by permission name, key, module, action..."
            />
          </div>
              ...
              {showColSettings && (
                ...
                >
                  ...
                  <div className="space-y-1.5 max-h-52 overflow-y-auto">
                    {[
                      { key: 'permKey', label: 'Permission Key & Module' },
                      { key: 'guard', label: 'Guard Scope' },
                      { key: 'actionType', label: 'Action Scope' },
                      { key: 'riskLevel', label: 'Security Risk Level' },
            ...
            >
              <div className="flex items-center justify-between border-b border-border pb-3">
                <h3 className="text-lg font-bold text-foreground flex items-center gap-2">
                  ...
                  <span>Import Permissions CSV</span>
                </h3>
                <button
                  onClick={() => {
                    setImportModalOpen(false)
              ...
              <div className="space-y-4">
                <div className="border-2 border-dashed border-border rounded-2xl p-6 text-center space-y-2 hover:border-primary/50 transition-colors">
                  <input
                    ...
                    className="hidden"
                    id="csvPermsFileInput"
                  />
                  <label htmlFor="csvPermsFileInput" className="cursor-pointer block space-y-2">
