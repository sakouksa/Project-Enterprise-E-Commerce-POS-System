      ...
      return [
        {
          ...
          value: 1,
          subtext: <span className="text-emerald-500 font-bold">Live on Storefront Header</span>,
          icon: Megaphone,
        ...
        },
        {
          ...
          value: 1,
          subtext: <span className="text-purple-500 font-bold">1-Click Apply Code</span>,
          icon: Sparkles,
          colorClass: 'bg-purple-500/10 text-purple-500',
        },
        {
          ...
          value: 2,
          subtext: <span className="text-blue-500 font-bold">🇰🇭 Khmer + 🇺🇸 English</span>,
          icon: BookOpen,
          colorClass: 'bg-blue-500/10 text-blue-500',
        },
        {
          key: 'campaign-health',
          title: t('cms.cardCampaignStatus', 'Campaign Status'),
          value: 100,
          suffix: '%',
          subtext: <span className="text-emerald-500 font-bold">Real-time Synchronized</span>,
          icon: ShieldCheck,
          colorClass: 'bg-emerald-500/10 text-emerald-500',
        },
      ]
