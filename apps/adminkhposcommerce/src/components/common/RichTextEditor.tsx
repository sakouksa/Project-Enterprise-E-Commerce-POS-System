      ...
      {activeTab === 'visual' && (
        <div className="flex flex-wrap items-center gap-1 p-2 border-b border-border/80 dark:border-slate-800 bg-card dark:bg-slate-900">
          ...
          <div className="flex items-center gap-1 pl-1.5">
            ...
            <div className="flex items-center gap-0.5 ml-1 pl-1.5 border-l border-border/70">
              <button
                type="button"
                onClick={() => insertCallout('info')}
                className="px-2 py-1 bg-blue-500/10 text-blue-600 dark:text-blue-400 hover:bg-blue-500/20 rounded-md text-[11px] font-bold cursor-pointer transition-colors"
              ...
              <button
                ...
                className="px-2 py-1 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/20 rounded-md text-[11px] font-bold cursor-pointer transition-colors"
              ...
              <button
                ...
                className="px-2 py-1 bg-amber-500/10 text-amber-600 dark:text-amber-400 hover:bg-amber-500/20 rounded-md text-[11px] font-bold cursor-pointer transition-colors"
