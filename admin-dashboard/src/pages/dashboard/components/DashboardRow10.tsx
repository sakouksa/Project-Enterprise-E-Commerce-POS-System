    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="bg-card border border-border/60 rounded-2xl p-5 shadow-sm">
        ...
        <div className="space-y-2">
          {[
            { name: t('departments.sales', 'Sales & Billing'), staff: `12 ${t('dashboard.staff', 'staff')}` },
            { name: t('departments.warehouse', 'Warehouse & Logistics'), staff: `8 ${t('dashboard.staff', 'staff')}` },
            { name: t('departments.marketing', 'Marketing & SEO'), staff: `4 ${t('dashboard.staff', 'staff')}` },
          ].map((dept, idx) => (
