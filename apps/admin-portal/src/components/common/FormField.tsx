...
export const getFieldClass = (
  ...
  const errorStyles = error
    ? 'border-rose-500 dark:border-rose-500 bg-rose-500/5 dark:bg-rose-500/10 focus:border-rose-500 focus:ring-2 focus:ring-rose-500/20 text-foreground dark:text-slate-100 placeholder:text-rose-400/60'
