            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {/* Card 1: Author */}
                  <div className="p-3.5 rounded-xl bg-muted/30 dark:bg-muted/10 border border-border/80 flex items-center gap-3 shadow-2xs">
                  ...
                  <div className="p-3.5 rounded-xl bg-muted/30 dark:bg-muted/10 border border-border/80 flex items-center gap-3 shadow-2xs">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs sm:text-[13px] font-bold text-foreground font-mono">
                  ...
                  <div className="p-3.5 rounded-xl bg-muted/30 dark:bg-muted/10 border border-border/80 flex items-center justify-between gap-2 shadow-2xs group">
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-xs sm:text-[13px] font-bold font-mono text-foreground truncate" title={`/${slug}`}>
                          /{slug}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    {excerpt && (
                      <div className="p-4 rounded-xl bg-amber-500/5 dark:bg-amber-500/10 border-l-4 border-amber-500 text-foreground text-sm font-medium italic leading-relaxed">
                        <p className="text-xs font-bold text-amber-600 dark:text-amber-400 not-italic uppercase tracking-wider mb-1 flex items-center gap-1.5">
                          <FileText size={13} />
