...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 1. Settings (15 keys)
        $settings = [
            ['key' => 'site_name', 'value' => 'NexTech Tbong Khmum', 'type' => 'string', 'group' => 'general'],
            ['key' => 'site_subtitle', 'value' => 'Tech Store & Smart POS', 'type' => 'string', 'group' => 'general'],
            ['key' => 'site_email', 'value' => 'tbongkhmum@enterprise-pos.com', 'type' => 'string', 'group' => 'general'],
            ['key' => 'allow_registration', 'value' => 'true', 'type' => 'boolean', 'group' => 'general'],
            ['key' => 'pos_receipt_header', 'value' => 'NexTech Tbong Khmum - សូមអរគុណសម្រាប់ការជាវទំនិញ!', 'type' => 'string', 'group' => 'pos'],
            ...
            ['key' => 'company_address', 'value' => 'ក្រុងសួង, ខេត្តត្បូងឃ្មុំ, ព្រះរាជាណាចក្រកម្ពុជា', 'type' => 'string', 'group' => 'company'],
