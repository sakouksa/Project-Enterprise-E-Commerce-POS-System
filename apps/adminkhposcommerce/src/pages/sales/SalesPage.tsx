...
const SalesPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ── 1. TOP 4 MODERN SLEEK METRIC CARDS - Only on Main Sales Orders Tab ── */}
      {tab === 'all' && (
        <SalesStatsCards
          revenue={pageTotals.revenue}
          completedOrders={pageTotals.completed}
          totalOrders={pagination.total}
          itemsSold={pageTotals.items}
          avgTicket={salesList.length > 0 ? pageTotals.revenue / salesList.length : 0}
        />
      )}
