    ...
    <div className={`relative ${className}`}>
      ...
      <div className="relative w-full">
        ...
        <select
          ...
          className={`w-full ${heightClass} font-medium rounded-lg border border-border/80 bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all pr-8 appearance-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed dark:bg-slate-900/90 dark:border-slate-800 dark:text-slate-100 ${
            displayIcon ? 'pl-9' : 'pl-3.5'
          } ${selectClassName} ${buttonClassName}`}
        >
