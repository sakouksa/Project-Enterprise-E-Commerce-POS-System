    ...
    public function run(): void
    {
        ...
        for ($i = 1; $i <= 10; $i++) {
            $shippingZones[] = [
                ...
                'provinces' => json_encode(['Phnom Penh', 'Kandal', 'Siem Reap', 'Battambang', 'Tbong Khmum']),
                'cities' => json_encode(['Khan Daun Penh', 'Khan Tuol Kouk', 'Krong Siem Reap', 'Krong Suong']),
                'created_at' => now(),
                'updated_at' => now(),
            ];
        }
        ...
        for ($oId = 1; $oId <= 150; $oId++) {
            ...
            $orders[] = [
                ...
                'shipping_phone' => '071 888 ' . str_pad($oId, 3, '0', STR_PAD_LEFT),
                'shipping_address' => "#" . ($oId * 3) . ", Street " . (($oId % 300) + 1) . ", Sangkat " . (($oId % 4) + 1),
                'shipping_city' => ($oId % 2 === 0 ? 'Khan Daun Penh' : 'Krong Siem Reap'),
                'shipping_province' => ($oId % 2 === 0 ? 'Phnom Penh' : 'Siem Reap'),
            ...
            $shipments[] = [
                ...
                'carrier' => ($oId % 2 === 0 ? 'Virak Buntham Logistics' : 'J&T Express Cambodia'),
