          ...
          <table className="w-full data-table border-collapse">
            ...
            <tbody>
              {isLoading ? (
                ...
                <EmptyState cols={4} message="No FAQs found." />
              ) : (
                records.map((r) => (
                    ...
                    {visibleColumns.title && (
                      <td>
                        <div>
                          ...
                          {r.answer && <p className="text-xs text-muted-foreground line-clamp-1">{r.answer}</p>}
                        </div>
                      </td>
                    )}
                    {visibleColumns.category && (
                      <td className="text-xs font-semibold text-foreground">{r.category || 'General'}</td>
                    )}
