...
import { CloseButton, CancelButton, TableToolbar } from '@/components/common'
...
const RecycleBinPage: React.FC = () => {
  ...
  return (
    <div className="space-y-5 print:p-0 relative pb-16">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 py-1 print:hidden relative overflow-hidden group">
        {/* Top Accent Stripe */}
