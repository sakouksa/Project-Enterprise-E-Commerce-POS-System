...
class WishlistController extends BaseApiController
{
    ...
    // ─── POST /api/v1/store/wishlist/add ────────────────────────────────────
    ...
    // ─── DELETE /api/v1/store/wishlist/{id} ─────────────────────────────────
    ...
    // ─── DELETE /api/v1/store/wishlist/product/{productId} ─────────────────
    ...
    // ─── POST /api/v1/store/wishlist/{id}/move-to-cart ──────────────────────
    ...
    // ─── POST /api/v1/store/wishlist/move-all-to-cart ────────────────────────
    ...
    // ─── GET /api/v1/store/wishlist/check/{productId} ────────────────────────
